...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped  table-hover" id="master_customer_table" style="width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th style="vertical-align: middle;">Kode Segment</th>
                        <th style="vertical-align: middle;">Nama Segment</th>
                        <th style="vertical-align: middle;">Kode Sales</th>
