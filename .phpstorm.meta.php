...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./media/agusprasetyo30/disk1/borwita/borwita-portal-web/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./media/agusprasetyo30/disk1/borwita/borwita-portal-web/public/storage',
...
'sanctum.csrf-cookie','dashboard','master.customer.index',
'master.customer.store','master.customer.update','master.salesman.index','master.salesman.store','master.salesman.update',
'transaction.invoice.index','transaction.credit-note.index','storage.local',);
        registerArgumentsSet('views', 
'auth.login','dashboard.index','layouts._breadcrumb','layouts._footer','layouts._navbar',
'layouts._sidebar','layouts.app','layouts.custom','master.customer.index','master.salesman.index',
'transaction.credit-note.index','transaction.invoice.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
